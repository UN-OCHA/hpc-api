...
export const Location = objectType({
    name: "Location",
    definition(t) {
      t.nonNull.float("adminLevel", { description: 'The admin level of the location' })
  ...
  export const Organization = objectType({
    name: "Organization",
    definition(t) {
      t.nonNull.string("abbreviation", { description: 'The abbrevation given to the organization' })
      ...
      t.string("comments", { description: 'The comments made on the organization' })
      t.nonNull.id("id")
      t.nonNull.string("name", { description: 'Name of the organization' })
      t.string("nativeName", { description: 'The native name given to the organization' })
      ...
      t.nonNull.boolean("verified", { description: 'Is the organization verified' })
    }
  })
  ...
  export const Participant = objectType({
    ...
    definition(t) {
      ...
      t.nonNull.string("name_family", { description: 'The name of the family of users to which the user belongs to' })
      t.nonNull.string("name_given", { description: 'The Name given to the user' })
  ...
  export const ParticipantCountry = objectType({
    ...
    definition(t) {
      ...
      t.nonNull.boolean("validated", { description: 'indicates when this was last validated on' })
    }
  })
